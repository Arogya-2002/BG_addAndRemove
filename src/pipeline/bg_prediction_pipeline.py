...
#     # These will later come from API inputs
#     input_image = r"C:\Users\Vamshi\Desktop\Projects\litzchill\remove_bg\data\sky2.jpg"
#     new_bg_image = r"C:\Users\Vamshi\Desktop\Projects\litzchill\remove_bg\data\bg1.jpg"

#     # Step 1: Remove background
#     rmbg_path = process_remove_bg(input_image)

#     # Step 2: Add new background
#     final_output_path = process_add_bg(rmbg_path, new_bg_image)

#     print(f"\n✅ Final image with background: {final_output_path}")
